...
export default class NIM{
     ...
     * @returns {*}
     */
    static sendCustomMessage(custype,data){
        return RNNeteaseIm.sendCustomMessage(custype,data);
    }
     ...
     * @returns {*}
     */
    static sendProductLink(custype,id,name,price,pic_url){
        return RNNeteaseIm.sendProductLink(custype,id,name,price,pic_url);
    }

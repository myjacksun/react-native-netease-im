...
//    content   //提醒内容
    @ReactMethod
    public void sendProductLink(String custype, String id,String name,String price,String pic_url,final Promise promise) {
        sessionService.sendProductLink("7", id, name,price,pic_url, new SessionService.OnSendMessageListener() {
            @Override
            public int onResult(int code, IMMessage message) {
                return 0;
            }
